...
<script src="/js/forum/board/boardForm.js"></script>
...
<body>
	...
	<div id="boardAddContainer">
		...
		<form id="boardForm" action="add" method="post" enctype="multipart/form-data" onsubmit="boardCheck(); return false;">
		...
		<input type="hidden" id="memberNo" name="memberNo" value="${memberVo.memberNo}">
		    ...
		    <div>
		        ...
		        <textarea id="boardContent2" name="boardContent2" rows="5"></textarea><br>
		    </div>
		    ...
		    <div id="btnDiv">
		        <input class="boardBtn3" type="submit" value="등록">
		        <input class="boardBtn3" type="reset" value="취소">
				<input class="boardBtn3" type="button" value="뒤로가기" onclick="pageMoveList();">
		    </div>
		</form>
	</div>
